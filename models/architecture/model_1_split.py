...
class Model_1_split(nn.Module):
    ...
    def forward(self, x):
        ...
        act = self.layer2_1(c1)
        loc = self.layer2_2(c1)
...
if __name__ == '__main__':
    ...
    data[0,:,:] = train_data[0,:,:]
    aplnet = Model_1_split(block=BasicBlock, layers=[1, 1, 1, 1], inchannel=52)
    out = aplnet(data)
